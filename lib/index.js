...
var _domReady = _interopRequireDefault(require("nil-dom-helpers/domReady"));

var _parseHTML = _interopRequireDefault(require("./selector/parseHTML"));

var _find = _interopRequireDefault(require("./selector/find"));

var _offset = _interopRequireDefault(require("nil-dom-helpers/offset"));

var _position = _interopRequireDefault(require("./position"));

var _offsetParent = _interopRequireDefault(require("nil-dom-helpers/offsetParent"));

var _matches = _interopRequireDefault(require("nil-dom-helpers/matches"));

var _classes = require("nil-dom-helpers/classes");

var _closest = _interopRequireDefault(require("nil-dom-helpers/closest"));

var _css = _interopRequireDefault(require("nil-dom-helpers/css"));
...
(0, _utils.each)({
  ...
  html: function (element, value) {
    if ((0, _utils.isUndefined)(value) && this.length) {
